package com.example.a19012011117_meetpatel_assignment_2.ui.dashboard
...
class DashboardFragment : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        upLoadBtn.setOnClickListener {
            if (mUploadTask != null && mUploadTask!!.isInProgress){
                Toast.makeText(this@DashboardFragment,
    ...
    var chooseImageView = findViewById<ImageView>(R.id.chooseImageView)
        ...
        if (mImageUri != null) {
            ...
            mUploadTask = fileReference.putFile(mImageUri!!)
                .addOnSuccessListener { taskSnapshot ->
                    ...
                    var descriptionEditText = findViewById<EditText>(R.id.descriptionEditText)
                    val upload = Collage(
                ...
                .addOnFailureListener { e ->
                    progressBar.visibility = View.INVISIBLE
                    Toast.makeText(this@DashboardFragment, e.message, Toast.LENGTH_SHORT).show()
    ...
    private fun  openImagesActivity() {
        startActivity(Intent(this@DashboardFragment, com.example.a19012011117_meetpatel_assignment_2.MainActivity::class.java))
    }
